...
function gwc_vt_help_topics(): array {
	$topics = array(
		...
		array(
			...
			'tasks' => array(
				array(
					'title' => __( 'Add a partner', 'groundwork-common-volunteer-tracker' ),
					'steps' => array(
						__( 'Go to <strong>Volunteer Tracker</strong> &rsaquo; <strong>Partners</strong>.', 'groundwork-common-volunteer-tracker' ),
						__( 'Select <strong>Add New Partner</strong>, beside the heading.', 'groundwork-common-volunteer-tracker' ),
						__( 'Enter the name, as you would say it out loud.', 'groundwork-common-volunteer-tracker' ),
						__( 'Select <strong>Add it</strong>.', 'groundwork-common-volunteer-tracker' ),
					),
					'note'  => __( 'Renaming one later is safe: every record points at the partner itself, so nothing moves. A local chapter of a national body can be set as part of it, and the national body then counts the chapter’s people and hours as well as its own.', 'groundwork-common-volunteer-tracker' ),
				),
				array(
					'title' => __( 'Record a CRM ID and who to ring', 'groundwork-common-volunteer-tracker' ),
					'steps' => array(
						__( 'Go to <strong>Volunteer Tracker</strong> &rsaquo; <strong>Partners</strong>.', 'groundwork-common-volunteer-tracker' ),
						__( 'Select the partner’s name.', 'groundwork-common-volunteer-tracker' ),
						...
						__( 'Select <strong>Save this partner</strong>.', 'groundwork-common-volunteer-tracker' ),
					),
				...
				array(
					...
					'note'  => __( 'This says who somebody is affiliated with. What a partner contributed is counted from the hours instead — somebody who came once with a company and twice on their own is one volunteer and three shifts, and only one of those is that company’s.', 'groundwork-common-volunteer-tracker' ),
				),
				array(
					'title' => __( 'Attribute a whole day to a partner', 'groundwork-common-volunteer-tracker' ),
					'steps' => array(
						__( 'Go to <strong>Volunteer Tracker</strong> &rsaquo; <strong>Hours</strong> and select <strong>Log a day</strong>.', 'groundwork-common-volunteer-tracker' ),
						__( 'Set the date and what they did.', 'groundwork-common-volunteer-tracker' ),
						__( 'Choose the partner under <strong>Came with</strong>.', 'groundwork-common-volunteer-tracker' ),
						__( 'Fill in the rows and select <strong>Log the hours</strong>.', 'groundwork-common-volunteer-tracker' ),
					),
					'note'  => __( 'One choice covers every row on the sheet, which is how a company sending twenty people for a morning actually arrives. Anybody on the list who came on their own can have it removed from their entry afterwards.', 'groundwork-common-volunteer-tracker' ),
				),
				array(
					'title' => __( 'Fold two partners into one', 'groundwork-common-volunteer-tracker' ),
					'steps' => array(
						__( 'Go to <strong>Volunteer Tracker</strong> &rsaquo; <strong>Partners</strong>.', 'groundwork-common-volunteer-tracker' ),
						__( 'Select the checkbox beside each one that is really the same partner.', 'groundwork-common-volunteer-tracker' ),
						__( 'Choose <strong>Fold together</strong> from <strong>Bulk actions</strong>, then select <strong>Apply</strong>.', 'groundwork-common-volunteer-tracker' ),
				...
				array(
					'title' => __( 'See what a partner contributed', 'groundwork-common-volunteer-tracker' ),
					'steps' => array(
						__( 'Go to <strong>Volunteer Tracker</strong> &rsaquo; <strong>Partners</strong>.', 'groundwork-common-volunteer-tracker' ),
						__( 'Find the partner in the list.', 'groundwork-common-volunteer-tracker' ),
						__( 'Select the figure in the <strong>Verified hours</strong> column, or the number in <strong>Volunteers</strong>.', 'groundwork-common-volunteer-tracker' ),
					),
					'note'  => __( 'The hours open the list of shifts that figure was counted from, with the same total above it; the number opens the people. You can narrow either list yourself with the dropdown above it.', 'groundwork-common-volunteer-tracker' ),
				),
			),
		),
