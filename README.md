...
Next: **hours required.** How many a mandated volunteer has to complete, by when, and for whom — stored on the volunteer beside the case that generated it, shown as progress on their record and used to decide who to call when a shift is short. Deliberately never printed on the letter: how many hours a court ordered is a fact about the court's document, not about anything the organization observed, and an organization certifying the terms of an order back to the court that issued it is the seal problem in a different hat.
