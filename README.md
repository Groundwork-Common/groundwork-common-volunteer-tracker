...
| `gwc_vt_menu_order` | filter | The order of the Volunteer Tracker submenu, by slug. |
...
| `gwc_vt_application_post_type_args` | filter | `register_post_type()` arguments for an offer to volunteer. |
| `gwc_vt_application_received` | action | After somebody has offered to volunteer. Nothing is a volunteer record yet. |
| `gwc_vt_application_approved` | action | After an offer became a volunteer record. Passed the volunteer and the offer. |
| `gwc_vt_application_discarded` | action | After an offer was set aside. |
| `gwc_vt_application_deleted` | action | Before an offer is deleted by the eraser or the retention sweep. |
